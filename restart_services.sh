...
# Dividir la ventana en 5 paneles (igual que el original)
tmux split-window -h
tmux split-window -v
...
# Reiniciar los servicios en cada panel
...
# # Esperar unos segundos para que los servicios estén arriba
# sleep 10

# # Precargar el modelo de inferencia enviando un prompt básico
# echo "Calentando modelo de inferencia..."
# curl -s -X POST http://localhost:5001/ticker_analysis \
#      -H "Content-Type: application/json" \
#      -d '{"prompt": "¿Qué es el aprendizaje automático?", "user_id": "warmup"}' >/dev/null
